package app.allulith.worldscape.createcharacter
...
import app.allulith.worldscape.createcharacter.fragments.CreateCharacterFragmentS3
...
class CreateCharacterActivity : AppCompatActivity() {
    ...
    fun resetFields(stageNumber: Int) {
        try {
            when (stageNumber) {
                ...
                2 -> {
                    // Currently has no relevant fields
                }
    ...
    fun setUpTextChangers(stageNumber: Int) {
        ...
        when (stageNumber) {
            ...
            2 -> {
                // Currently has no TextInputEditTexts
            }
